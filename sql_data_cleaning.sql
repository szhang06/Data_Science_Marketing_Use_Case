...
SELECT * 
FROM ifood.dbo.ml_project1_data;
...
AND TABLE_NAME = 'ml_project1_data';   
...
--ALTER TABLE ml_project1_data
--DROP COLUMN Age;

ALTER TABLE ml_project1_data
ADD Age INT;

UPDATE ml_project1_data
...
ALTER TABLE ifood.dbo.ml_project1_data
ADD Days_Member INT;

UPDATE ifood.dbo.ml_project1_data
...
ALTER TABLE ml_project1_data  -- run first, then update, cannot run together
...
EXEC sp_rename 'ml_project1_data.MntGoldProds', 'MntGoldProducts', 'COLUMN';
...
SELECT COLUMN_NAME
FROM INFORMATION_SCHEMA.COLUMNS
WHERE TABLE_NAME = 'ml_project1_data'
...
ALTER TABLE ml_project1_data
DROP COLUMN Year_Birth, Education, Marital_Status;

-- drop rows containing NULL values


DELETE FROM ifood.dbo.ml_project1_data
